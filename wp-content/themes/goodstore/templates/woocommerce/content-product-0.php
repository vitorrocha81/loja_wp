<?php
/**
 * The default template for displaying product/light content
 */
?>
...
if (class_exists('WooCommerce')) {
    ...
    <article id="product-<?php the_ID(); ?>"  <?php post_class(array('element', 'col-lg-3', 'product-style-0', 'product-animate', $catalog_mode_class)); ?>   
        ...
        <div class="box ">
            ...
            <div class="image <?php echo esc_attr($class); ?>">
                ...
                if (has_post_thumbnail()) {
                    ...
                    //default
                    //echo '<img src="YOUR_DEFAULT_IMAGE" alt="'.get_the_title().'" />';
                }
