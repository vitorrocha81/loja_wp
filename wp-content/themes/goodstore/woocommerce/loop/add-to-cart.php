...
<?php if ( ! $product->is_in_stock() ) : ?>
	...
	<a href="<?php echo apply_filters( 'out_of_stock_add_to_cart_url', get_permalink( $product->id ) ); ?>" class="post_name"><span class="icon-info2"></span><?php echo apply_filters( 'out_of_stock_add_to_cart_text', __( 'Details', 'jawtemplates' ) ); ?></a>
