...
$of_options[] = array(
    "name" => "Format",
    "type" => "sectionstart");
$of_options[] = array("name" => "Number of Letter in title other articles",
    "desc" => "This is a number of letter in a preview content.",
...
$jaw_sc_builder_options['woo_carousel_small'] = $of_options;
