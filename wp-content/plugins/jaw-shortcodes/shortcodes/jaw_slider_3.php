...
class jaw_slider_3 {
    ...
    public function jaw_slider_3_shortcode($atts, $content = null, $code = null) {
        $cache_id = 'slider3_'.jaw_cache_get_id().'_'.jaw_template_inc_counter('cache_tmpl');
    ...
    private function model($atts) {
        ...
        if (isset($atts['disable_fadein'])) {
            $blog_query->disable_fadein = $atts['disable_fadein'];
        } else {
            $blog_query->disable_fadein = '0';
        }
