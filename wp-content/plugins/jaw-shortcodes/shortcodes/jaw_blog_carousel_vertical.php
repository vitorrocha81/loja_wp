...
class jaw_blog_carousel_vertical {
    ...
    public function jaw_blog_carousel_vertical_shortcode($atts, $content = null, $code = null) {
        $cache_id = 'blog_carver_'.jaw_cache_get_id().'_'.jaw_template_inc_counter('cache_tmpl');
